...
const bakePies = (pieType, recipe, pieQuantity) => {
...
const sellPies = (costOfPie, pieQuantity, profitMargin = 1.2) => {
...
function bakeAndSellPies(pieType, pieQuantity, profitMargin) {
  ...
  //! helper function to calculate cost of each pie with its ingredients
  // const costOfPie = recipe.reduce((prev, current) => {
  //   return prev + current.cost;
  // }, recipe[0].cost);
  // console.log(`Cost per pie: ${costOfPie}`);
  ...
  // Print the total revenue calculated using the given profitMargin
  //! helper function to get revenue from pies
  // const revenue = totalCost * (profitMargin || 1.2);
  // console.log(`Sold ${pieQuantity} pies for $${revenue.toFixed(2)}!`);
