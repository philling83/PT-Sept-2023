...
const _getFullName = person => person.firstName + " " + person.lastName;
...
const _coupon = (discount) => (prices) => prices.map((price) => (price -= price * discount));
